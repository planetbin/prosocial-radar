...
Pipeline:
  ...
  -> structured AI summarize -> split CSV/JSON outputs -> email push -> run report
"""
...
def main():
    ...
    report["stages"]["scored"] = len(papers)
    ...
    all_csv = save_csv(papers, out_dir, prefix="all_candidates")
    all_json = save_json(papers, out_dir, prefix="all_candidates")
